"""RMVPE (Robust Model for Vocal Pitch Estimation in Polyphonic Music) の推論コード.

RVC-Project/Retrieval-based-Voice-Conversion-WebUI (MIT License, Copyright (c) 2023 liujing04) の
infer/rmvpe.py をほぼそのまま同梱している。CUDA グラフ関連の依存だけ外した。
論文: Wei et al., "RMVPE: A Robust Model for Vocal Pitch Estimation in Polyphonic Music", Interspeech 2023.
"""


def run_cuda_graph(owner, namespace, function, *inputs):  # noqa: D401  (元コードの CUDA グラフ最適化は使わない)
